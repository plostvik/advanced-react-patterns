...
function useControlledSwitchWarning(
  ...
  const valueIsControlled = controlValue != null
  const {current: valueWasControlled} = React.useRef(valueIsControlled)

  React.useEffect(() => {
    warning(
      !(valueIsControlled && !valueWasControlled),
  ...
  }, [componentName, controlPropName, valueIsControlled, valueWasControlled])
}

function useControlledReadOnlyWarning(
  valueIsControlled,
  controlPropName,
  componentName,
  hasOnChange,
